...
function vk_dynamic_if_block_migration_page() 
{
    ...
    // 移行結果を表示
    if (isset($_GET['migration_result']) && $_GET['migration_result'] === 'success' && isset($_SESSION['vk_migration_result'])) {
        $result = $_SESSION['vk_migration_result'];
        unset($_SESSION['vk_migration_result']);
            ...
            <div class="tablenav top">
                <div class="alignleft actions bulkactions">
                    <select name="vk_bulk_action">
                        ...
                        <option value="vk_migrate_blocks"><?php _e('Migrate Dynamic If Blocks', 'vk-dynamic-if-block'); ?></option>
                    </select>
